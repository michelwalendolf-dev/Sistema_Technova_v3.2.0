...
class PDFViewerApp:
    def __init__(self, root):
        self.root = root
        self.root.title("Manual do Sistema de Locação")
        ...
        self.default_status_text = "Manual Operacional do Sistema de Locação."
        ...
        # Carregar estrutura de arquivos do diretório "Manual do Sistema de Locação"
        self.manual_dir = "Manual do Sistema de Locação" \
        ""
